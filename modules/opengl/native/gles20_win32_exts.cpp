...
void InitGLES20(){
	...
	(void*&)glBindAttribLocation=wglGetProcAddress("glBindAttribLocation");
	(void*&)glBindBuffer=wglGetProcAddress("glBindBuffer");
	(void*&)glBindFramebuffer=wglGetProcAddress("glBindFramebuffer");
	(void*&)glBindRenderbuffer=wglGetProcAddress("glBindRenderbuffer");
	(void*&)glBlendColor=wglGetProcAddress("glBlendColor");
	(void*&)glBlendEquation=wglGetProcAddress("glBlendEquation");
	(void*&)glBlendEquationSeparate=wglGetProcAddress("glBlendEquationSeparate");
	(void*&)glBlendFuncSeparate=wglGetProcAddress("glBlendFuncSeparate");
	(void*&)glBufferData=wglGetProcAddress("glBufferData");
	(void*&)glBufferSubData=wglGetProcAddress("glBufferSubData");
	(void*&)glCheckFramebufferStatus=wglGetProcAddress("glCheckFramebufferStatus");
	(void*&)glClearDepthf=wglGetProcAddress("glClearDepthf");
	...
	(void*&)glDepthRangef=wglGetProcAddress("glDepthRangef");
	(void*&)glDetachShader=wglGetProcAddress("glDetachShader");
	(void*&)glDisableVertexAttribArray=wglGetProcAddress("glDisableVertexAttribArray");
	(void*&)glEnableVertexAttribArray=wglGetProcAddress("glEnableVertexAttribArray");
	(void*&)glFramebufferRenderbuffer=wglGetProcAddress("glFramebufferRenderbuffer");
	(void*&)glFramebufferTexture2D=wglGetProcAddress("glFramebufferTexture2D");
	(void*&)glGenBuffers=wglGetProcAddress("glGenBuffers");
	(void*&)glGenerateMipmap=wglGetProcAddress("glGenerateMipmap");
	(void*&)glGenFramebuffers=wglGetProcAddress("glGenFramebuffers");
	(void*&)glGenRenderbuffers=wglGetProcAddress("glGenRenderbuffers");
	(void*&)glGetActiveAttrib=wglGetProcAddress("glGetActiveAttrib");
	(void*&)glGetActiveUniform=wglGetProcAddress("glGetActiveUniform");
	(void*&)glGetAttachedShaders=wglGetProcAddress("glGetAttachedShaders");
	...
	(void*&)glGetFramebufferAttachmentParameteriv=wglGetProcAddress("glGetFramebufferAttachmentParameteriv");
	(void*&)glGetProgramiv=wglGetProcAddress("glGetProgramiv");
	(void*&)glGetProgramInfoLog=wglGetProcAddress("glGetProgramInfoLog");
	(void*&)glGetRenderbufferParameteriv=wglGetProcAddress("glGetRenderbufferParameteriv");
	(void*&)glGetShaderiv=wglGetProcAddress("glGetShaderiv");
	(void*&)glGetShaderInfoLog=wglGetProcAddress("glGetShaderInfoLog");
	(void*&)glGetShaderPrecisionFormat=wglGetProcAddress("glGetShaderPrecisionFormat");
	(void*&)glGetShaderSource=wglGetProcAddress("glGetShaderSource");
	(void*&)glGetUniformfv=wglGetProcAddress("glGetUniformfv");
	(void*&)glGetUniformiv=wglGetProcAddress("glGetUniformiv");
	(void*&)glGetUniformLocation=wglGetProcAddress("glGetUniformLocation");
	(void*&)glGetVertexAttribfv=wglGetProcAddress("glGetVertexAttribfv");
	(void*&)glGetVertexAttribiv=wglGetProcAddress("glGetVertexAttribiv");
	(void*&)glGetVertexAttribPointerv=wglGetProcAddress("glGetVertexAttribPointerv");
	(void*&)glIsBuffer=wglGetProcAddress("glIsBuffer");
	(void*&)glIsFramebuffer=wglGetProcAddress("glIsFramebuffer");
	(void*&)glIsProgram=wglGetProcAddress("glIsProgram");
	(void*&)glIsRenderbuffer=wglGetProcAddress("glIsRenderbuffer");
	(void*&)glIsShader=wglGetProcAddress("glIsShader");
	(void*&)glLinkProgram=wglGetProcAddress("glLinkProgram");
	(void*&)glReleaseShaderCompiler=wglGetProcAddress("glReleaseShaderCompiler");
	(void*&)glRenderbufferStorage=wglGetProcAddress("glRenderbufferStorage");
	(void*&)glSampleCoverage=wglGetProcAddress("glSampleCoverage");
	(void*&)glShaderBinary=wglGetProcAddress("glShaderBinary");
	(void*&)glShaderSource=wglGetProcAddress("glShaderSource");
	(void*&)glStencilFuncSeparate=wglGetProcAddress("glStencilFuncSeparate");
	(void*&)glStencilMaskSeparate=wglGetProcAddress("glStencilMaskSeparate");
	(void*&)glStencilOpSeparate=wglGetProcAddress("glStencilOpSeparate");
	...
	(void*&)glUniform1iv=wglGetProcAddress("glUniform1iv");
	(void*&)glUniform2f=wglGetProcAddress("glUniform2f");
	(void*&)glUniform2fv=wglGetProcAddress("glUniform2fv");
	(void*&)glUniform2i=wglGetProcAddress("glUniform2i");
	(void*&)glUniform2iv=wglGetProcAddress("glUniform2iv");
	(void*&)glUniform3f=wglGetProcAddress("glUniform3f");
	(void*&)glUniform3fv=wglGetProcAddress("glUniform3fv");
	(void*&)glUniform3i=wglGetProcAddress("glUniform3i");
	(void*&)glUniform3iv=wglGetProcAddress("glUniform3iv");
	(void*&)glUniform4f=wglGetProcAddress("glUniform4f");
	(void*&)glUniform4fv=wglGetProcAddress("glUniform4fv");
	(void*&)glUniform4i=wglGetProcAddress("glUniform4i");
	(void*&)glUniform4iv=wglGetProcAddress("glUniform4iv");
	(void*&)glUniformMatrix2fv=wglGetProcAddress("glUniformMatrix2fv");
	(void*&)glUniformMatrix3fv=wglGetProcAddress("glUniformMatrix3fv");
	...
	(void*&)glVertexAttrib1f=wglGetProcAddress("glVertexAttrib1f");
	(void*&)glVertexAttrib1fv=wglGetProcAddress("glVertexAttrib1fv");
	(void*&)glVertexAttrib2f=wglGetProcAddress("glVertexAttrib2f");
	(void*&)glVertexAttrib2fv=wglGetProcAddress("glVertexAttrib2fv");
	(void*&)glVertexAttrib3f=wglGetProcAddress("glVertexAttrib3f");
	(void*&)glVertexAttrib3fv=wglGetProcAddress("glVertexAttrib3fv");
	(void*&)glVertexAttrib4f=wglGetProcAddress("glVertexAttrib4f");
	(void*&)glVertexAttrib4fv=wglGetProcAddress("glVertexAttrib4fv");
