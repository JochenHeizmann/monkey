...
Function LoadImageData:DataBuffer( path$,info[]=[] )="bb_opengl_gles20.LoadImageData"
...
Function glTexImage2D:Void( target, level, internalformat, format, type, path:String )="bb_opengl_gles20._glTexImage2D"
...
Function glTexSubImage2D:Void( target, level, xoffset, yoffset, format, type, path:String )="bb_opengl_gles20._glTexSubImage2D"
...
Function glDrawElements:Void( mode, count, type, ptr:DataBuffer )="gl.drawElements"
...
Function glVertexAttribPointer:Void( indx, size, type, normalized?, stride, data:DataBuffer )="gl.vertexAttribPointer"
