...
Import trans.jstranslator
Import trans.astranslator
Import trans.cstranslator
Import trans.cpptranslator
Import trans.javatranslator
...
Function LoadConfig()
	...
	For Local line$=Eachin cfg.Split( "~n" )
		...
		'If err=1 Print "Config error: "+lhs+" does not appear to be a valid path"
...
Function Main()
	...
	Print "TRANS monkey compiler V0.1"
