...
Const ABOUT$="Monk 0.34 - a free editor for monkey coders by Simon Armstrong"
Const IDE_VERSION$="0.34 Release Version"
...
' init gadgets
		...
		w=optionspanel		
		buttons[0]=CreateButton("Show Toolbar",6,6,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[1]=CreateButton("Open Files at Startup",6,34,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[2]=CreateButton("Auto Capitalize",6,60,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[3]=CreateButton("Syntax Highlighting",6,86,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[4]=CreateButton("Enable .bmx Bracket Matching",6,112,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[5]=CreateButton("Auto Backup"+" to .bak",6,138,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[6]=CreateButton("Auto Indent",6,164,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[7]=CreateButton("Hide Output When Process Completes",6,190,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[8]=CreateButton("Use External Help Browser",6,216,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[9]=CreateButton("Use OS Specific Shortcut Keys",6,242,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
		buttons[10]=CreateButton("Sort Nodes in Code View",6,268,ClientWidth(w)-12,26,w,BUTTON_CHECKBOX)
...
Type THelpPanel Extends TToolPanel
	...
	Method SyncDocs()
		...
		For Local m$=EachIn EnumModules()
			...
			If Not link link=AddLink( host.helproot,"Third party modules","" )
			AddLink link,m,p
		Next

		link=AddLink( host.helproot,"Index","" )
...
Type TProjects Extends TNode
	...
	Method NewProject()
		addproj.Detach
		Local proj:TProjectFolderNode = TProjectFolderNode.CreateProjectNode(Self,"New Project")
'		proj.scan(Self)
		Append proj
		Append addproj
...
Type TCodePlay
	...
	Field monkeypath$,transpath$,monkpath$
	Field inipath$
...
?
		...
		Catch err$
			homedir=monkpath
			bmxpath=Null 
'			SetStatus "Unable to determine BlitzMax installation directory."
